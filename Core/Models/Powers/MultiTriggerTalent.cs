...
/// <summary>
///     <see cref="TriggerTalent" /> that can trigger a move an arbitrary number of times, but never on removal.
/// </summary>
public abstract class MultiTriggerTalent : TriggerTalent
{
    /// <summary>
    ///     No big icon on <see cref="MultiTriggerTalent" /> to prevent certain visual quirks related to this power flashing
